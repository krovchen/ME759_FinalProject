function CodeDefine() { 
this.def = new Array();
this.def["gblNumToFiles"] = {file: "sync_mach_cont_sim_cpp.html",line:28,type:"var"};
this.def["gblNumFrFiles"] = {file: "sync_mach_cont_sim_cpp.html",line:29,type:"var"};
this.def["gblNumFrWksBlocks"] = {file: "sync_mach_cont_sim_cpp.html",line:30,type:"var"};
this.def["gblSlvrJacPatternFileName"] = {file: "sync_mach_cont_sim_cpp.html",line:31,type:"var"};
this.def["gblNumRootInportBlks"] = {file: "sync_mach_cont_sim_cpp.html",line:35,type:"var"};
this.def["gblNumModelInputs"] = {file: "sync_mach_cont_sim_cpp.html",line:36,type:"var"};
this.def["gblInportDataTypeIdx"] = {file: "sync_mach_cont_sim_cpp.html",line:39,type:"var"};
this.def["gblInportDims"] = {file: "sync_mach_cont_sim_cpp.html",line:41,type:"var"};
this.def["gblInportComplex"] = {file: "sync_mach_cont_sim_cpp.html",line:43,type:"var"};
this.def["gblInportInterpoFlag"] = {file: "sync_mach_cont_sim_cpp.html",line:45,type:"var"};
this.def["gblInportContinuous"] = {file: "sync_mach_cont_sim_cpp.html",line:47,type:"var"};
this.def["rtB"] = {file: "sync_mach_cont_sim_cpp.html",line:53,type:"var"};
this.def["rtX"] = {file: "sync_mach_cont_sim_cpp.html",line:56,type:"var"};
this.def["rtDW"] = {file: "sync_mach_cont_sim_cpp.html",line:59,type:"var"};
this.def["rtU"] = {file: "sync_mach_cont_sim_cpp.html",line:62,type:"var"};
this.def["rtY"] = {file: "sync_mach_cont_sim_cpp.html",line:65,type:"var"};
this.def["model_S"] = {file: "sync_mach_cont_sim_cpp.html",line:74,type:"var"};
this.def["rtS"] = {file: "sync_mach_cont_sim_cpp.html",line:75,type:"var"};
this.def["rt_powd_snf"] = {file: "sync_mach_cont_sim_cpp.html",line:82,type:"fcn"};
this.def["rtb_Fcn1"] = {file: "sync_mach_cont_sim_cpp.html",line:160,type:"var"};
this.def["tmp"] = {file: "sync_mach_cont_sim_cpp.html",line:161,type:"var"};
this.def["i"] = {file: "sync_mach_cont_sim_cpp.html",line:162,type:"var"};
this.def["i_0"] = {file: "sync_mach_cont_sim_cpp.html",line:163,type:"var"};
this.def["_rtXdot"] = {file: "sync_mach_cont_sim_cpp.html",line:528,type:"var"};
this.def["anyStateSaturated"] = {file: "sync_mach_cont_sim_cpp.html",line:571,type:"var"};
this.def["mdlInfo"] = {file: "sync_mach_cont_sim_cpp.html",line:658,type:"var"};
this.def["B"] = {file: "sync_mach_cont_sim_h.html",line:93,type:"type"};
this.def["DW"] = {file: "sync_mach_cont_sim_h.html",line:114,type:"type"};
this.def["X"] = {file: "sync_mach_cont_sim_h.html",line:122,type:"type"};
this.def["XDot"] = {file: "sync_mach_cont_sim_h.html",line:130,type:"type"};
this.def["XDis"] = {file: "sync_mach_cont_sim_h.html",line:138,type:"type"};
this.def["CStateAbsTol"] = {file: "sync_mach_cont_sim_h.html",line:146,type:"type"};
this.def["ZCV"] = {file: "sync_mach_cont_sim_h.html",line:158,type:"type"};
this.def["ConstP"] = {file: "sync_mach_cont_sim_h.html",line:166,type:"type"};
this.def["ExtU"] = {file: "sync_mach_cont_sim_h.html",line:172,type:"type"};
this.def["ExtY"] = {file: "sync_mach_cont_sim_h.html",line:180,type:"type"};
this.def["rtConstP"] = {file: "sync_mach_cont_sim_data_cpp.html",line:25,type:"var"};
...
this.def["rtDataTypeSizes"] = {file: "sync_mach_cont_sim_dt_h.html",line:22,type:"var"};
this.def["rtDataTypeNames"] = {file: "sync_mach_cont_sim_dt_h.html",line:40,type:"var"};
this.def["rtBTransitions"] = {file: "sync_mach_cont_sim_dt_h.html",line:58,type:"var"};
this.def["rtBTransTable"] = {file: "sync_mach_cont_sim_dt_h.html",line:70,type:"var"};
...
function Html2SrcLink() {
	...
	this.html2SrcPath["sync_mach_cont_sim_cpp.html"] = "../sync_mach_cont_sim.cpp";
	this.html2Root["sync_mach_cont_sim_cpp.html"] = "sync_mach_cont_sim_cpp.html";
	this.html2SrcPath["sync_mach_cont_sim_h.html"] = "../sync_mach_cont_sim.h";
	this.html2Root["sync_mach_cont_sim_h.html"] = "sync_mach_cont_sim_h.html";
	this.html2SrcPath["sync_mach_cont_sim_private_h.html"] = "../sync_mach_cont_sim_private.h";
	this.html2Root["sync_mach_cont_sim_private_h.html"] = "sync_mach_cont_sim_private_h.html";
	this.html2SrcPath["sync_mach_cont_sim_types_h.html"] = "../sync_mach_cont_sim_types.h";
	this.html2Root["sync_mach_cont_sim_types_h.html"] = "sync_mach_cont_sim_types_h.html";
	this.html2SrcPath["sync_mach_cont_sim_data_cpp.html"] = "../sync_mach_cont_sim_data.cpp";
	this.html2Root["sync_mach_cont_sim_data_cpp.html"] = "sync_mach_cont_sim_data_cpp.html";
	...
	this.html2SrcPath["sync_mach_cont_sim_dt_h.html"] = "../sync_mach_cont_sim_dt.h";
	this.html2Root["sync_mach_cont_sim_dt_h.html"] = "sync_mach_cont_sim_dt_h.html";
...
var fileList = [
"sync_mach_cont_sim_cpp.html","sync_mach_cont_sim_h.html","sync_mach_cont_sim_private_h.html","sync_mach_cont_sim_types_h.html","sync_mach_cont_sim_data_cpp.html","builtin_typeid_types_h.html","multiword_types_h.html","rtGetInf_cpp.html","rtGetInf_h.html","rtGetNaN_cpp.html","rtGetNaN_h.html","rt_defines_h.html","rt_nonfinite_cpp.html","rt_nonfinite_h.html","rtwtypes_h.html","rtmodel_h.html","sync_mach_cont_sim_dt_h.html","rt_logging_c.html"];
